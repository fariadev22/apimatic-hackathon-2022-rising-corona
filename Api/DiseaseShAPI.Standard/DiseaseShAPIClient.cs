// <copyright file="DiseaseShAPIClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace DiseaseShAPI.Standard
{
    using System;
    ...
    /// </summary>
    public sealed class DiseaseShAPIClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Default, "https://disease.sh/" },
                }
            },
        };
        ...
        private readonly Lazy<COVID19WorldometersController> cOVID19Worldometers;

        private DiseaseShAPIClient(
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.cOVID19Worldometers = new Lazy<COVID19WorldometersController>(
                () => new COVID19WorldometersController(this, this.httpClient, this.authManagers, this.httpCallBack));
        }

        /// <summary>
        /// Gets COVID19WorldometersController controller.
        /// </summary>
        public COVID19WorldometersController COVID19WorldometersController => this.cOVID19Worldometers.Value;
        ...
        /// <summary>
        /// Creates an object of the DiseaseShAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> DiseaseShAPIClient.</returns>
        internal static DiseaseShAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("DISEASE_SH_API_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = DiseaseShAPI.Standard.Environment.Production;
